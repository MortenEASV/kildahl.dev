...
const About = () => {
    return (
        <article className={styles.about}>
            ...
            <p className={`${styles.about__text} ${globalStyles.text__normal}`}>Hello! </p>
            <p className={`${styles.about__text} ${globalStyles.text__normal}`}>
               My name is Morten. I am a full-stack developer currently studying computer science at <a href="https://www.linkedin.com/school/erhvervsakademi-sydvest/">Business Academy SouthWest</a> in Denmark.
            </p>
            <p className={`${styles.about__text} ${globalStyles.text__normal}`}>
